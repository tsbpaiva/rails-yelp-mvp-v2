# # Restaurant.destroy_all if Rails.env.development? - I don't quite know what that means
...
puts "Done! You now have #{Restaurant.count} restaurants in your database."
